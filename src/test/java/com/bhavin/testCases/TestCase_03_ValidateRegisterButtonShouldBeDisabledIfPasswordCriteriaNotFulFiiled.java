...
public class TestCase_03_ValidateRegisterButtonShouldBeDisabledIfPasswordCriteriaNotFulFiiled extends TestBase {
	...
	/**
	 * Validate register button should be disabled if password criteria not
	 * fulfiiled.
	 *
	 * @throws InterruptedException the interrupted exception
	 */
	@Test(groups = {
			"Login Suite" }, description = "TestCase_03_Validate register button should be disabled if password criteria not fulfiiled")
